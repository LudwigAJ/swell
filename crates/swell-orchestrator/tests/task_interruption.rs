...
use std::sync::Arc;
use swell_core::{
    AgentId, AutonomyLevel, Plan, PlanStep, RiskLevel, StepStatus, TaskId, TaskState,
};
...
async fn setup_executing_task(orchestrator: &Orchestrator) -> (TaskId, swell_core::Task) {
